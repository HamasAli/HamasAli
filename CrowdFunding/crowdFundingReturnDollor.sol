...
contract crowdFunding{
    ...
    function contribute() public payable returns(bool){
        require(msg.value >= minContribution, 
                "Sorry, your contribution is too low.");
    ...
    function Vote(uint _proposalNumber) public returns(bool){
        ...
        require(vote[_proposalNumber][msg.sender] == false, 
    ...
    function approve(uint _proposalNumber) public onlyManger returns(bool){
        ...
        require(totalAmountInTheContract >= thisProposal.amount, 
    ...
    function EthToUsdt() public view returns(uint){
        uint usdt = uint(_getLatestPrice()) * address(this).balance;
        return usdt; // divide it by 10^26 in front end as USDT in Goerli is 10^8 and ETH is 10^18
    }
